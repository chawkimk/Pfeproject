...
namespace MeetingPlanner.Tests
{
    public class EventControllerTests : IntegrationTestBase
    {
        ...
        [Theory]
        [InlineData("/api/events/global?date=2024-11-03")]
        ...
        public async Task GlobalEventsGetEndpoint_ShouldReturnBothEventsFromDatabase(string url)
        {
            ...
            var firstDate = new DateTime(2025, 11, 15);
            var secondDate = new DateTime(2025, 11, 16);
        ...
        [Theory]
        [InlineData("/api/events/global?date=2025-11-03")]
        ...
        [Theory]
        [InlineData("/api/events?date=2024-11-03")]
